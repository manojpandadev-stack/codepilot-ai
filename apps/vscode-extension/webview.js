(function() {
  ...
  function App() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-vscode-bg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-vscode-border flex-shrink-0", children: ["chat", "tools", "changes", "settings"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: tab === "chat" ? "💬 Chat" : tab === "tools" ? `🔧 Tools (${toolEvents.length})` : tab === "changes" ? `📝 Changes (${fileChanges.length})` : "⚙️ Settings"
        },
        tab
      )) }),
