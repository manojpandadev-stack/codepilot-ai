(function () {
  ...
  function requireReactDomClient_production() {
    ...
    function getNextLanes(root3, wipLanes, rootHasPendingCommit) {
      ...
      var nextLanes = 0,
        suspendedLanes = root3.suspendedLanes,
        pingedLanes = root3.pingedLanes;
            ...
            : ((pingedLanes &= nonIdlePendingLanes),
              0 !== pingedLanes
                ...
                : rootHasPendingCommit ||
                  ((rootHasPendingCommit = nonIdlePendingLanes & ~root3),
        ...
        : ((nonIdlePendingLanes = pendingLanes & ~suspendedLanes),
          0 !== nonIdlePendingLanes
            ...
            : 0 !== pingedLanes
              ? (nextLanes = getHighestPriorityLanes(pingedLanes))
              : rootHasPendingCommit ||
                ((rootHasPendingCommit = pendingLanes & ~root3),
                0 !== rootHasPendingCommit &&
    ...
    function checkIfRootIsPrerendering(root3, renderLanes2) {
      return (
        0 ===
        (root3.pendingLanes &
          ~(root3.suspendedLanes & ~root3.pingedLanes) &
          renderLanes2)
      );
    }
    ...
    function markRootFinished(
      ...
      var entanglements = root3.entanglements,
        expirationTimes = root3.expirationTimes,
        hiddenUpdates = root3.hiddenUpdates;
      for (
    ...
    function markSpawnedDeferredLane(root3, spawnedLane, entangledLanes) {
      ...
      root3.entanglements[spawnedLaneIndex] =
        root3.entanglements[spawnedLaneIndex] |
        1073741824 |
    ...
    function markRootEntangled(root3, entangledLanes) {
      ...
      for (root3 = root3.entanglements; rootEntangledLanes;) {
        var index$8 = 31 - clz32(rootEntangledLanes),
          lane = 1 << index$8;
        (lane & entangledLanes) | (root3[index$8] & entangledLanes) &&
          (root3[index$8] |= entangledLanes);
    ...
    function getBumpedLaneForHydration(root3, renderLanes2) {
      ...
      return 0 !== (renderLane & (root3.suspendedLanes | renderLanes2))
        ? 0
        : renderLane;
    }
    ...
    function getResourcesFromRoot(root3) {
      ...
      resources ||
        (resources = root3[internalRootNodeResourcesKey] =
          {
    ...
    function getData() {
      ...
      var start,
        ...
        endValue = "value" in root2 ? root2.value : root2.textContent,
      ...
      if (isComposing)
        return "compositionend" === domEventName ||
          ...
          ? ((domEventName = getData()),
            (fallbackText = startText = root2 = null),
            (isComposing = false),
            domEventName)
          : null;
      switch (domEventName) {
          ...
          null !== returnFiber
            ? (0 === (returnFiber.flags & 65536) && (returnFiber.flags |= 256),
              ...
              value !== HydrationMismatchException &&
                ((root3 = Error(formatProdErrorMessage(422), { cause: value })),
                queueHydrationError(
                  createCapturedValueAtFiber(root3, sourceFiber),
                )))
            : (value !== HydrationMismatchException &&
              ...
              (root3 = root3.current.alternate),
              (root3.flags |= 65536),
              (rootRenderLanes &= -rootRenderLanes),
              (root3.lanes |= rootRenderLanes),
              ...
              enqueueCapturedUpdate(root3, rootRenderLanes),
      ...
      do {
        switch (sourceFiber.tag) {
          case 3:
            return (
              (sourceFiber.flags |= 65536),
              (root3 = rootRenderLanes & -rootRenderLanes),
              (sourceFiber.lanes |= root3),
              (root3 = createRootErrorUpdate(
                sourceFiber.stateNode,
                value,
                root3,
              )),
              enqueueCapturedUpdate(sourceFiber, root3),
              false
            );
          case 1:
            if (
    ...
    function commitBeforeMutationEffects(root3, firstChild) {
      ...
      if (hasSelectionCapabilities(root3)) {
        if ("selectionStart" in root3)
          ...
          a: {
            JSCompiler_temp =
              ((JSCompiler_temp = root3.ownerDocument) &&
      ...
      for (nextEffect = firstChild; null !== nextEffect;)
        if (
          ...
          (root3 = firstChild.child),
          0 !== (firstChild.subtreeFlags & 1028) && null !== root3)
        )
          ...
          for (; null !== nextEffect;) {
            ...
            switch (firstChild.tag) {
              case 0:
                if (
                  0 !== (root3 & 4) &&
                  ((root3 = firstChild.updateQueue),
                  (root3 = null !== root3 ? root3.events : null),
                  null !== root3)
                )
                  for (
                    JSCompiler_temp = 0;
                    JSCompiler_temp < root3.length;
                    JSCompiler_temp++
                  )
                    ((anchorOffset = root3[JSCompiler_temp]),
              ...
              case 3:
                if (0 !== (root3 & 1024)) {
                  if (
                    ((root3 = firstChild.stateNode.containerInfo),
                    (JSCompiler_temp = root3.nodeType),
                    9 === JSCompiler_temp)
                  )
          ...
          if (flags & 8192)
            a: for (
              root3 = finishedWork.stateNode,
                root3._visibility = hoistableRoot
                  ? root3._visibility & -2
                  : root3._visibility | 1,
                hoistableRoot &&
                  (null === current ||
              ...
              if (5 === root3.tag || 26 === root3.tag) {
                ...
                ((22 !== root3.tag && 23 !== root3.tag) ||
                  null === root3.memoizedState ||
                  root3 === finishedWork) &&
                null !== root3.child
              ) {
    ...
    function recursivelyTraverseLayoutEffects(root3, parentFiber) {
      if (parentFiber.subtreeFlags & 8772)
        for (parentFiber = parentFiber.child; null !== parentFiber;)
          (commitLayoutEffectOnFiber(root3, parentFiber.alternate, parentFiber),
            (parentFiber = parentFiber.sibling));
    }
    ...
    function scheduleUpdateOnFiber(root3, fiber, lane) {
      if (
        ...
        null !== root3.cancelPendingCommit
      )
            ...
            if (0 !== JSCompiler_inline_result) {
              ...
              a: {
                ...
                var wasRootDehydrated =
                  root3.current.memoizedState.isDehydrated;
                wasRootDehydrated &&
                  (prepareFreshStack(root3, JSCompiler_inline_result).flags |=
                    256);
    ...
    function markRootSuspended(
      ...
      0 !== spawnedLane &&
        markSpawnedDeferredLane(root3, spawnedLane, suspendedLanes);
    }
    ...
    function prepareFreshStack(root3, lanes) {
      ...
      -1 !== timeoutHandle &&
        ((root3.timeoutHandle = -1), cancelTimeout(timeoutHandle));
      timeoutHandle = root3.cancelPendingCommit;
      null !== timeoutHandle &&
        ((root3.cancelPendingCommit = null), timeoutHandle());
      pendingEffectsLanes = 0;
      ...
      if (0 !== allEntangledLanes)
        for (
          root3 = root3.entanglements, allEntangledLanes &= lanes;
          0 < allEntangledLanes;
        ) {
    ...
    function renderRootConcurrent(root3, lanes) {
      ...
      var prevDispatcher = pushDispatcher(),
        prevAsyncDispatcher = pushAsyncDispatcher();
      workInProgressRoot !== root3 || workInProgressRootRenderLanes !== lanes
        ? ((workInProgressTransitions = null),
    ...
    function throwAndUnwindWorkLoop(
      ...
      if (unitOfWork.flags & 32768) {
        if (isHydrating || 1 === suspendedReason) root3 = true;
          ...
          ((workInProgressRootDidSkipSuspendedSiblings = root3 = true),
          2 === suspendedReason ||
            9 === suspendedReason ||
            3 === suspendedReason ||
            6 === suspendedReason)
        ...
        if (
          ...
          try {
            ...
            var priorSelectionInformation = selectionInformation,
              curFocusedElem = getActiveElementDeep(root3.containerInfo),
      ...
      if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
        ...
        0 !== (finishedWork.flags & 10256)
          ...
          : ((pendingEffectsStatus = 0),
            ...
            releaseRootPooledCache(root3, root3.pendingLanes));
        ...
        if (null !== recoverableErrors) {
          ...
          try {
            for (
              var onRecoverableError = root3.onRecoverableError, i = 0;
        ...
        0 !== (lanes & 261930) && 0 !== (remainingLanes & 42)
          ? root3 === rootWithNestedUpdates
            ? nestedUpdateCount++
            : ((nestedUpdateCount = 0), (rootWithNestedUpdates = root3))
          : (nestedUpdateCount = 0);
        flushSyncWorkAcrossRoots_impl(0);
      }
    }
    function releaseRootPooledCache(root3, remainingLanes) {
      0 === (root3.pooledCacheLanes &= remainingLanes) &&
        ((remainingLanes = root3.pooledCache),
        null != remainingLanes &&
          ((root3.pooledCache = null), releaseCache(remainingLanes)));
    }
    ...
    function attachPingListener(root3, wakeable, lanes) {
      ...
      threadIDs.has(lanes) ||
        ...
        threadIDs.add(lanes),
        (root3 = pingSuspendedRoot.bind(null, root3, wakeable, lanes)),
        wakeable.then(root3, root3));
    }
    function pingSuspendedRoot(root3, wakeable, pingedLanes) {
      ...
      workInProgressRoot === root3 &&
        ...
        (3 === workInProgressRootExitStatus &&
          ...
          ? 0 === (executionContext & 2) && prepareFreshStack(root3, 0)
    ...
    function ensureRootIsScheduled(root3) {
      root3 !== lastScheduledRoot &&
        null === root3.next &&
        (null === lastScheduledRoot
          ? (firstScheduledRoot = lastScheduledRoot = root3)
          : (lastScheduledRoot = lastScheduledRoot.next = root3));
    ...
    function processRootScheduleInMicrotask() {
      ...
      for (
        var currentTime = now(), prev = null, root3 = firstScheduledRoot;
        null !== root3;
      ) {
        var next = root3.next,
          nextLanes = scheduleTaskForRootDuringMicrotask(root3, currentTime);
        if (0 === nextLanes)
          ((root3.next = null),
            null === prev ? (firstScheduledRoot = next) : (prev.next = next),
            null === next && (lastScheduledRoot = prev));
        else if (
          ((prev = root3), 0 !== syncTransitionLanes || 0 !== (nextLanes & 3))
        )
          mightHavePendingSyncWork = true;
        root3 = next;
      }
    ...
    function scheduleTaskForRootDuringMicrotask(root3, currentTime) {
      for (
        var suspendedLanes = root3.suspendedLanes,
          pingedLanes = root3.pingedLanes,
          expirationTimes = root3.expirationTimes,
          lanes = root3.pendingLanes & -62914561;
        0 < lanes;
      ) {
      ...
      if (
        0 === (suspendedLanes & 3) ||
        checkIfRootIsPrerendering(root3, suspendedLanes)
      ) {
    ...
    function performWorkOnRootViaSchedulerTask(root3, didTimeout) {
      ...
      return null != root3.callbackNode &&
        root3.callbackNode === originalCallbackNode
        ? performWorkOnRootViaSchedulerTask.bind(null, root3)
        : null;
    }
            ...
            (useFallbackCompositionData &&
              ...
              (isComposing || "onCompositionStart" !== eventType
                ...
                : ((root2 = nativeEventTarget),
                  (startText =
                    "value" in root2 ? root2.value : root2.textContent),
                  (isComposing = true))),
    ...
    function insertStylesheet(instance, precedence, root3) {
      for (
        var nodes = root3.querySelectorAll(
      ...
      prior
        ...
        : ((precedence = 9 === root3.nodeType ? root3.head : root3),
    ...
    function insertStylesheetIntoRoot(root3, resource) {
      if (!(resource.state.loading & 4)) {
        ...
        i
          ...
          : ((root3 = 9 === root3.nodeType ? root3.head : root3),
          ...
          for (; null !== blockedOn;) {
            ...
            if (null !== fiber)
              switch (fiber.tag) {
                ...
                case 31:
                case 13:
                  ((root3 = enqueueConcurrentRenderForLane(fiber, 2)),
                    null !== root3 && scheduleUpdateOnFiber(root3, fiber, 2),
                    flushSyncWork$1(),
  ...
  function DiffViewer({
    ...
    if (changes.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        className:
          "flex items-center justify-center h-full text-vscode-desc text-sm",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className:
            "flex items-center gap-2 px-3 py-2 border-b border-vscode-border flex-shrink-0",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
              className: "text-[11px] font-semibold text-vscode-desc",
              children: [
                changes.length,
                " file",
                changes.length !== 1 ? "s" : "",
                ...
                jsxRuntimeExports.Fragment,
                {
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                      onClick: onAcceptAll,
                      className:
                        "text-[11px] px-2 py-1 rounded bg-green-900 text-green-300 hover:bg-green-800",
                      children: "✓ Accept All",
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                      onClick: onRejectAll,
                      className:
                        "text-[11px] px-2 py-1 rounded bg-red-900 text-red-300 hover:bg-red-800",
                      children: "✗ Reject All",
                    }),
                  ],
                },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              className:
                "w-56 border-r border-vscode-border overflow-y-auto flex-shrink-0",
                  ...
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                        className: `font-mono font-semibold ${iconColor} mr-1`,
                        children: icon,
                      }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        className: "text-[9px] text-vscode-desc truncate",
              ...
              children: selected
                ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className:
                          "flex items-center gap-2 px-3 py-2 bg-vscode-editor-bg border-b border-vscode-border sticky top-0",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                            className: "text-[11px] font-mono text-vscode-fg",
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "button",
                                  {
                                    ...
                                    className:
                                      "text-[10px] px-2 py-0.5 rounded bg-green-900 text-green-300 hover:bg-green-800",
                                    children: "✓ Accept",
                                  },
                                ),
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "button",
                                  {
                                    ...
                                    className:
                                      "text-[10px] px-2 py-0.5 rounded bg-red-900 text-red-300 hover:bg-red-800",
                                    children: "✗ Reject",
                                  },
                                ),
                              ],
                        ...
                        children: selected.diff
                          ...
                          : selected.newContent
                            ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", {
                                className:
                                  "px-3 py-2 text-[11px] font-mono text-vscode-fg whitespace-pre-wrap",
                                children: selected.newContent,
                              })
                            : selected.status === "deleted" &&
                                selected.oldContent
                              ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", {
                                  className:
                                    "px-3 py-2 text-[11px] font-mono text-red-300 whitespace-pre-wrap",
                                  children: selected.oldContent,
                                })
                              : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                                  className:
                                    "px-3 py-4 text-sm text-vscode-desc text-center",
                ...
                : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className:
                      "flex items-center justify-center h-full text-vscode-desc text-sm",
                    children: "Select a file to view changes.",
                  }),
            }),
          ],
        }),
  ...
  function App() {
            ...
            setHealingState((prev) =>
              prev
                ? {
                    ...
                    message:
                      msg.payload.diagnosis ??
                      msg.payload.repairDescription ??
                      prev.message,
                  }
                : null,
            );
    ...
    const handleMCPApproval = reactExports.useCallback(
      (requestId, decision) => {
    ...
    const handleAttachFile = reactExports.useCallback(() => {
      const filePath = window.prompt(
        "Enter file path to attach (relative to workspace):\nExample: src/main.ts",
      );
    ...
    const handleAttachFolder = reactExports.useCallback(() => {
      const folderPath = window.prompt(
        "Enter folder path to attach (relative to workspace):\nExample: src/backend",
      );
    ...
    const handleAttachUrl = reactExports.useCallback(() => {
      const url = window.prompt(
        "Enter URL to fetch and attach as context:\nExample: https://docs.example.com/api",
      );
      if (url && url.trim()) {
    ...
    const handleAcceptFile = reactExports.useCallback(
      (path) => {
    ...
    const handleRejectFile = reactExports.useCallback(
      (path) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      className: "flex flex-col h-screen bg-vscode-bg",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", {
          className:
            "flex items-center justify-between px-3 py-2 border-b border-vscode-border flex-shrink-0",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "flex items-center gap-2",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  className: "text-sm font-semibold text-vscode-fg",
                  children: "🤖 CodePilot AI",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  className:
                    "text-[10px] px-1.5 py-0.5 rounded bg-vscode-badge-bg text-vscode-badge-fg",
                  children: "v0.1.0",
                }),
              ],
            }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                className: `text-[10px] px-2 py-0.5 rounded-full font-semibold ${settings.privacyMode === "local" ? "bg-green-900 text-green-300" : settings.privacyMode === "cloud" ? "bg-orange-900 text-orange-300" : "bg-yellow-900 text-yellow-300"}`,
                children:
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className:
            "flex items-center gap-2 px-3 py-1.5 border-b border-vscode-border flex-shrink-0",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", {
              value: settings.agentMode,
              onChange: (e) =>
                setSettings((s) => ({ ...s, agentMode: e.target.value })),
              className:
                "text-[11px] px-2 py-1 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg",
              children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", {
              ...
              className:
                "text-[11px] px-2 py-1 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg flex-1",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                  value: "qwen3:8b",
                  children: "qwen3:8b (tool calling)",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                  value: "qwen3:4b",
                  children: "qwen3:4b (tool calling)",
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          className: "flex border-b border-vscode-border flex-shrink-0",
          children: ["chat", "tools", "changes", "history", "settings"].map(
            (tab) =>
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
        ...
        mcpApprovals.length > 0 &&
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            className: "border-b border-orange-600 bg-orange-950",
            children: mcpApprovals.map((approval) =>
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "px-3 py-2",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                          ...
                          children: "⚠️ MCP Tool Request",
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                          className: `text-[9px] px-1.5 py-0.5 rounded font-semibold ${approval.riskLevel === "high" ? "bg-red-800 text-red-200" : approval.riskLevel === "medium" ? "bg-orange-800 text-orange-200" : "bg-yellow-800 text-yellow-200"}`,
                          children: approval.riskLevel.toUpperCase(),
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      className: "text-[11px] text-orange-100 space-y-0.5 mb-2",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                          children: [
                            "Server: ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                              className: "font-mono text-orange-200",
                              children: approval.serverName,
                            }),
                          ],
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        ...
                        Object.keys(approval.arguments).length > 0 &&
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                                className: "font-mono text-orange-200",
                                children: JSON.stringify(approval.arguments),
                              }),
                            ],
                          }),
                      ],
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                          onClick: () =>
                            handleMCPApproval(approval.requestId, "approve"),
                          className:
                            "text-[11px] px-3 py-1 rounded font-medium bg-green-800 text-green-200 hover:bg-green-700",
                          children: "✓ Approve",
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                          onClick: () =>
                            handleMCPApproval(approval.requestId, "reject"),
                          className:
                            "text-[11px] px-3 py-1 rounded font-medium bg-red-800 text-red-200 hover:bg-red-700",
                          children: "✗ Reject",
                        }),
                      ],
                    }),
            ...
            currentTab === "chat" &&
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [
                      messages.length === 0 &&
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                          className:
                            "text-center text-vscode-desc text-sm py-8",
                          children:
                      ...
                      messages.map((msg) =>
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            className: `text-sm ${msg.role === "user" ? "text-vscode-fg" : ""}`,
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                                className:
                                  "text-[10px] font-semibold uppercase tracking-wider text-vscode-desc mb-1",
                                children:
                                  msg.role === "user"
                                    ? "You"
                                    : msg.role === "assistant"
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                                className: `px-3 py-2 rounded-lg whitespace-pre-wrap ${msg.role === "user" ? "bg-vscode-editor-bg border border-vscode-border" : msg.role === "system" ? "bg-red-950 border border-red-800 text-red-300" : "bg-vscode-quote-bg"}`,
                      ...
                      streamingText &&
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                              className:
                                "px-3 py-2 rounded-lg bg-vscode-quote-bg whitespace-pre-wrap",
                      ...
                      toolEvents.length > 0 &&
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                          className: "space-y-1",
                          children: toolEvents.map((evt) =>
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                className:
                                  "flex items-center gap-2 text-[11px] px-3 py-1 rounded bg-vscode-editor-bg border-l-2 border-vscode-text-link",
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "span",
                                    {
                                      className: `w-2 h-2 rounded-full ${evt.status === "started" ? "bg-yellow-400 animate-pulse" : evt.status === "completed" ? "bg-green-400" : "bg-red-400"}`,
                                    },
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "span",
                                    {
                                      className:
                                        "font-mono text-vscode-text-link font-semibold",
                                      children: evt.name,
                                    },
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                    className:
                      "px-3 py-2 border-t border-vscode-border flex-shrink-0",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                              ...
                              className:
                                "px-1.5 py-2 rounded-lg text-[11px] text-vscode-desc border border-vscode-input-border hover:bg-vscode-btn-hover hover:text-vscode-fg",
                              title: "Attach @file",
                              children: "📎",
                            }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                              onClick: handleAttachProblems,
                              className:
                                "px-1.5 py-2 rounded-lg text-[11px] text-vscode-desc border border-vscode-input-border hover:bg-vscode-btn-hover hover:text-vscode-fg",
                              title: "Attach @problems",
                              children: "⚠️",
                            }),
                          ],
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", {
                          ...
                          rows: 2,
                          className:
                            "flex-1 text-sm px-3 py-2 rounded-lg border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg resize-none focus:outline-none focus:border-vscode-focus-border",
                        }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                          onClick: handleSend,
                          disabled: !input.trim() || isRunning,
                          className:
                            "px-4 py-2 rounded-lg text-sm font-medium text-vscode-btn-fg bg-vscode-btn hover:bg-vscode-btn-hover disabled:opacity-40 disabled:cursor-not-allowed",
                          children: "Send",
                        }),
                        lastPrompt &&
                          !isRunning &&
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                            ...
                            className:
                              "px-3 py-2 rounded-lg text-sm font-medium text-vscode-btn-fg border border-vscode-input-border hover:bg-vscode-btn-hover",
                            children: "↻ Retry",
                          }),
                        !isRunning &&
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                            ...
                            className:
                              "px-3 py-2 rounded-lg text-sm font-medium text-yellow-400 border border-yellow-600 hover:bg-yellow-900/30",
                            children: "🔧 Heal",
                          }),
                      ],
                    }),
            ...
            currentTab === "tools" &&
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                children:
                  toolEvents.length === 0
                    ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        className: "text-center text-vscode-desc text-sm py-8",
                        children: "No tool activity yet.",
                      })
                    : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        className: "space-y-2",
                        children: toolEvents.map((evt) =>
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            ...
                            {
                              className:
                                "px-3 py-2 rounded bg-vscode-editor-bg border border-vscode-border",
                                ...
                                "div",
                                {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "span",
                                      {
                                        className: `w-2 h-2 rounded-full ${evt.status === "started" ? "bg-yellow-400" : evt.status === "completed" ? "bg-green-400" : "bg-red-400"}`,
                                      },
                                    ),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "span",
                                      {
                                        className:
                                          "font-mono text-vscode-text-link",
                                        children: evt.name,
                                      },
                                    ),
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                        ...
                        className:
                          "text-[10px] px-2 py-0.5 rounded border border-vscode-input-border text-vscode-desc hover:text-vscode-fg",
                        children: "Refresh",
                      }),
                    ],
                  }),
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      ...
                                      {
                                        className:
                                          "text-[11px] text-vscode-fg font-mono",
                                  ...
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "button",
                                      {
                                        ...
                                        className:
                                          "text-[10px] px-2 py-0.5 rounded bg-vscode-btn text-vscode-btn-fg hover:bg-vscode-btn-hover",
                                        children: "Resume",
                                      },
                                    ),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "button",
                                      {
                                        ...
                                        className:
                                          "text-[10px] px-2 py-0.5 rounded border border-red-800 text-red-400 hover:bg-red-900",
                                        children: "Delete",
                                      },
                                    ),
                                  ],
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", {
                        className:
                          "block text-[11px] font-semibold text-vscode-desc mb-1",
                        children: "Provider",
                      }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", {
                        ...
                        className:
                          "w-full text-sm px-2 py-1 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                            value: "ollama",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                            value: "local",
                            children: "Local Only — no data leaves machine",
                          }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                            value: "hybrid",
                            children: "Hybrid — cloud only for selected tasks",
                          }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", {
                            value: "cloud",
                            children: "Cloud — uses API providers",
                          }),
                        ],
                      }),
                    ],
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("input", {
                        ...
                        className:
                          "w-full text-sm px-2 py-1 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg font-mono",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", {
                        className:
                          "block text-[11px] font-semibold text-vscode-desc mb-2",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      ...
                                      {
                                        className:
                                          "text-[11px] text-vscode-fg group-hover:text-vscode-text-link",
                                        children: label,
                                      },
                                    ),
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                      ...
                                      {
                                        className:
                                          "text-[10px] text-vscode-desc ml-1",
                                        children: ["— ", desc],
                                      },
                                    ),
                                  ],
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("label", {
                            ...
                            children: "Max consecutive auto-approvals:",
                          }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("input", {
                            type: "number",
                            min: 1,
                            ...
                            className:
                              "ml-2 w-16 text-[11px] px-1 py-0.5 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg",
                          }),
                        ],
                      }),
                    ],
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("label", {
                        className:
                          "block text-[11px] font-semibold text-vscode-desc mb-2",
                        children: "Project Rules (.clinerules/)",
                      }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                        className: "text-[11px] text-vscode-desc space-y-1",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
                            children: [
                              "Rules are loaded from ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("code", {
                                className: "text-vscode-text-link",
                                children: ".clinerules/",
                              }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("code", {
                                children: ".clinerules/backend/spring.md",
                              }),
                              ").",
                            ],
                          }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                            className: "mt-2 text-[10px] text-vscode-desc",
                            children:
                              "Rules influence agent instructions. They cannot bypass PolicyEngine or security controls.",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                        ...
                        className:
                          "mt-2 text-[10px] px-2 py-0.5 rounded border border-vscode-input-border text-vscode-desc hover:text-vscode-fg",
        ...
        healingState &&
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className:
              "px-3 py-2 bg-vscode-editor-bg border-t border-vscode-border",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                className:
                  "flex items-center justify-between text-[10px] text-vscode-desc mb-1",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                    children: ["🔧 Self-healing: ", healingState.phase],
                  }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                    children: [
                      "Attempt ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                className:
                  "w-full h-1.5 bg-vscode-editor-bg rounded-full overflow-hidden",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                  className: "h-full bg-yellow-500 rounded-full transition-all",
                  style: {
                    width: `${(healingState.attempt / healingState.maxAttempts) * 100}%`,
                  },
                }),
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                className: "text-[10px] text-vscode-desc mt-1 truncate",
                children: healingState.message,
              }),
            ],
          }),
        healingState &&
          !healingState.active &&
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            className: `px-3 py-1 text-[10px] ${healingState.success ? "text-green-500" : "text-red-500"}`,
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          className:
            "flex items-center justify-between px-3 py-1 border-t border-vscode-border text-[10px] text-vscode-desc flex-shrink-0",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              className: "flex items-center gap-2",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                  children: isRunning ? "Agent running..." : "Ready",
                }),
                usage &&
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                        className:
                          "w-16 h-1.5 bg-vscode-editor-bg rounded-full overflow-hidden",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                          className:
                            "h-full bg-vscode-text-link rounded-full transition-all",
                          style: {
                            width: `${Math.min(((usage.inputTokens + usage.outputTokens) / 128e3) * 100, 100)}%`,
                          },
                        }),
                      }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                        children: [
                          Math.round(
                            ((usage.inputTokens + usage.outputTokens) / 128e3) *
                              100,
                          ),
                          "%",
                        ],
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
                  children: [settings.provider, " / ", settings.model],
                }),
              ],
            }),
          ],
